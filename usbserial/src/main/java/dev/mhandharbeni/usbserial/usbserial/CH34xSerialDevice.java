...
import dev.mhandharbeni.usbserial.utils.SafeUsbRequest;
...
public class CH34xSerialDevice extends UsbSerialDevice
{
    ...
    // Parity values
    public static final int CH34X_PARITY_NONE = 0xc3;
    public static final int CH34X_PARITY_ODD = 0xcb;
    public static final int CH34X_PARITY_EVEN = 0xdb;
    public static final int CH34X_PARITY_MARK = 0xeb;
    public static final int CH34X_PARITY_SPACE = 0xfb;

    //Flow control values
    public static final int CH34X_FLOW_CONTROL_NONE = 0x0000;
    public static final int CH34X_FLOW_CONTROL_RTS_CTS = 0x0101;
    public static final int CH34X_FLOW_CONTROL_DSR_DTR = 0x0202;
    ...
    public void setParameters(int baudRate, int dataBits, int stopBits, int parity) throws IOException {
        ...
        int ret = setControlCommandOut(0x9a, 0x2518, lcr, null);
        if (ret < 0) {
